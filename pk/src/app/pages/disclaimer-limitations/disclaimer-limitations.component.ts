...
@Component({
  selector: "app-disclaimer-limitations",
  templateUrl: "./disclaimer-limitations.component.html",
  styleUrls: ["./disclaimer-limitations.component.css"]
})
export class DisclaimerLimitationsComponent implements OnInit {
  contentUrl =
    environment.apiUrl + "pages/disclaimer-and-limitations-of-liability";
  pagecontent: any;
  ...
  setSeo() {
    ...
    link.setAttribute(
      "href",
      this.seopath + "/disclaimer-limitations-liability"
    );
  }
  /* SEO SETTINGS Close*/
}
