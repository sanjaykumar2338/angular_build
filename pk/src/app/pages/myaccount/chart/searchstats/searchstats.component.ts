...
@Component({
  selector: "app-searchstats",
  templateUrl: "./searchstats.component.html",
  styleUrls: ["./searchstats.component.css"]
})
export class SearchstatsComponent implements OnInit {
  ...
  public searchlineChartData: ChartDataSets[] = [];
  public searchlineChartLabels: [];
  ...
  currentweek() {
    ...
    this.http
      ...
      .subscribe(
        (res: any) => {
          this.searchlineChartLabels = res.labels;
          this.searchlineChartData = res.data;
          this.chart.update();
        },
        (msg: any) => {
          console.log(msg);
