...
export class WebstatsComponent implements OnInit {
  ...
  public weblineChartData: ChartDataSets[] = [];
  public weblineChartLabels: [];
  ...
  currentweek() {
    ...
    this.http
      ...
      .subscribe(
        (res: any) => {
          this.weblineChartLabels = res.labels;
          this.weblineChartData = res.data;
          this.chart.update();
        },
        (msg: any) => {
          console.log(msg);
