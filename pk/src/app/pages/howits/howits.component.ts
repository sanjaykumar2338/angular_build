...
@Component({
  selector: "app-howits",
  templateUrl: "./howits.component.html",
  styleUrls: ["./howits.component.css"]
})
export class HowitsComponent implements OnInit {
  ...
  setSeo() {
    ...
    link.setAttribute("href", this.seopath + "/how-it-works");
  }
  /* SEO SETTINGS Close*/
}
