...
@Component({
  selector: "app-termchild",
  templateUrl: "./termchild.component.html",
  styleUrls: ["./termchild.component.css"]
})
export class TermchildComponent implements OnInit {
  ...
  setSeo() {
    ...
    link.setAttribute(
      "href",
      this.seopath + "/terms-and-conditions/" + this.childSlug
    );
  }
  /* SEO SETTINGS Close*/
}
