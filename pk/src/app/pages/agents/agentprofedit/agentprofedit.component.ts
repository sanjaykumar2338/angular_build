...
@Component({
  selector: "app-agentprofedit",
  templateUrl: "./agentprofedit.component.html",
  styleUrls: ["./agentprofedit.component.css"]
})
export class AgentprofeditComponent implements OnInit {
    ...
    this.http
      ...
      .subscribe(
        (res: any) => {
          ...
          this.bankdetail = "";
          this.paypal_id = this.data.paypal_id ? this.data.paypal_id : "";
          ...
          this.profileForm.patchValue({
            ...
            paypal_id: this.data.paypal_id ? this.data.paypal_id : ""
          });
        },
        msg => {
          console.log(msg);
  ...
  onSubmit() {
    if (this.profileForm.valid) {
      ...
      var form = this.profileForm.value;
      /*   console.log(form); */
      var editUrl = environment.apiUrl + "agent/editprofile/" + this.logeduser;
      this.http
        .post(
          editUrl,
          {
        ...
        .subscribe(
          data => {
            ...
            this.window.location.href =
              environment.siteUrl + "agent/profile-edit";
          },
          msg => {
            console.log(msg);
